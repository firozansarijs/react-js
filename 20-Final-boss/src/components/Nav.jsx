    ...
    <div >
     ...
     >Contact</a>
      ...
      <div className="flex items-center gap-8 ">
        <Search className='hover:scale-95 hover:text-green-300' />
        <User className='hover:scale-95 hover:text-green-300' />
     <div className="relative">
       <ShoppingBag className='hover:scale-95 hover:text-green-300'  />
